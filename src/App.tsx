...
import { getStoredOnboardingProfile } from "@/lib/onboarding-state";
      ...
      <div className="flex-1 w-full">
        {isPersonApp ? (
          isOnboardingActive ? (
            ...
            <PersonApp onRevisitOnboarding={() => setIsOnboardingActive(true)} />
          )
        ) : (
          ...
          <div className="flex items-center gap-1.5 flex-wrap justify-center" aria-label="Role Switcher">
            <button
              ...
              className={`px-2.5 py-1 rounded-md text-xs font-bold transition-all ${
                isPersonApp && isOnboardingActive
                  ? "bg-[#1a3826] text-white shadow-sm ring-1 ring-[#d97706]"
